...
var TASK_NAME = "moderation";
var TaskModeration = /** @class */ (function () {
    function TaskModeration() {
    }
    TaskModeration.prototype.solve = function () {
        return __awaiter(this, void 0, void 0, function () {
            var authResponse, taskResponse, request, resultOfModeration, flaggedModeration, answerRequest;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, OpenApi_1.default.moderation(request)];
                    case 3:
                        resultOfModeration = _a.sent();
                        flaggedModeration = resultOfModeration.results.map(function (result) { return result.flagged; });
                        answerRequest = {
...
exports.default = TaskModeration;
